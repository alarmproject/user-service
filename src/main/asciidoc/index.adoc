...
[[resources-userchangeschool]]
==== 학교 변경

include::{snippets}/userrestdocstest/userchangeschool/request-parameters.adoc[]
include::{snippets}/userrestdocstest/userchangeschool/response-fields.adoc[]
include::{snippets}/userrestdocstest/userchangeschool/http-request.adoc[]
include::{snippets}/userrestdocstest/userchangeschool/http-response.adoc[]
include::{snippets}/userrestdocstest/userchangeschool/curl-request.adoc[]
